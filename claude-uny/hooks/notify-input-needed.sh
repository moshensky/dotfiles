...
#   echo '{"message":"Permission needed: Bash(rm -rf /)"}' | ~/.claude-uny/hooks/notify-input-needed.sh
#   echo '{}' | ~/.claude-uny/hooks/notify-input-needed.sh   # missing .message -> default text
set -uo pipefail
